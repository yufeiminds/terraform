...
func TestNormalizeFlatmapContainers(t *testing.T) {
	for i, tc := range []struct {
		...
		{
			attrs:  map[string]string{"map.%": config.UnknownVariableValue, "list.#": config.UnknownVariableValue, "id": "1"},
			expect: map[string]string{"id": "1", "map.%": config.UnknownVariableValue, "list.#": config.UnknownVariableValue},
		},
		{
		...
		{
			prior:  map[string]string{"map.%": config.UnknownVariableValue, "list.#": "0"},
			attrs:  map[string]string{"map.%": "0", "list.#": "0", "id": "1"},
